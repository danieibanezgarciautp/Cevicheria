...
<%@page import="DAO.RAreservadoDAO" %>
...
<html>
    <head>
        ...
        <title>..::Registro Alojamiento Reservado::..</title>
    ...
    <body>
        <%! 
            RAreservadoDAO raDAO = new RAreservadoDAO();
        %>
        <div class="container">

            <hr>
            <div class="row align-items-start">
                <div class="col-9"><h1>Alojamiento Reservado</h1></div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="${pageContext.servletContext.contextPath}/RAreservadoServlet" method="POST" role="form">
                            <div class="row">
                                <div class="col-6">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="txtFechaEntrada" class="form-control" id="txtFechaEntrada">
                                </div>
                                <div class="col-6">
                                    <label>Fecha de Salida</label>
                                    <input type="text" name="txtFechaSalida" class="form-control" id="txtFechaSalida">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
        ...
        <script src="${pageContext.servletContext.contextPath}/js/rareservado.js"></script>
    </body>
</html>